...
<!-- global variables -->
     ...
     <xsl:variable name="labely"><xsl:value-of select="//metric_name[@id='M1']"/></xsl:variable>
     <xsl:variable name="title1">Distribution <xsl:value-of select="$labely"/></xsl:variable>
